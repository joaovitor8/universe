  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-5">
      ...
      <div className="flex space-x-2">
        ...
        <InputGeneric type="date" />
        <ButtonGeneric onClick={GetApod}>Search</ButtonGeneric>
      </div>
      ...
      <div className="flex   max-[1022px]:flex-col max-[1022px]:space-y-3   min-[1023px]:space-x-2">
        ...
        <div className="h-min w-[500px] p-5 border border-RoxoNeon rounded-md space-y-5   max-[426px]:w-[300px] max-[540px]:w-[400px]">
          <div>
