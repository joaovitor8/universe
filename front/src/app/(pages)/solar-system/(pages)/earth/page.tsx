...
export default function Earth() {
  return (
    <main className="flex flex-col items-center">
      <div className="w-[300px] text-justify space-y-4 sm:w-[500px] md:w-[700px] lg:w-[1000px]">
        <div>
          <div>
            <div>
            ...
            <img src="/planets/earth.png" alt="Planet" className="my-4" />
          </div>
        ...
        <div className="space-y-2">
          <h2 className="text-3xl text-purple-700">Space Exploration</h2>
