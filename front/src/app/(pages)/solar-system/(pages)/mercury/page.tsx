  ...
  return (
    <main className="flex flex-col items-center text-justify my-20">
      ...
      <div className="w-[800px] flex flex-col gap-5 max-[900px]:w-[600px] max-[700px]:w-[300px]">
        <div className="flex gap-5 max-[700px]:flex-col">
          <div className="flex flex-col justify-around">
            <h2 className="text-4xl text-yellow-600 mt-10 mb-20">Mercury: The Closest Planet to the Sun</h2>
      ...
      <div className="w-[800px] flex gap-5 max-[900px]:w-[600px] max-[700px]:w-[300px] max-[700px]:flex-col">
        <div>
          <h3 className="text-yellow-600 text-3xl text-center mb-3">Geology</h3>
          <p><span className="text-yellow-600">Surface:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
          <p><span className="text-yellow-600">Volcanoes:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
          <p><span className="text-yellow-600">Craters:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
          <p><span className="text-yellow-600">Mountains:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
        </div>
        <div>
          <h3 className="text-yellow-600 text-3xl text-center mb-3">Atmosphere</h3>
          <p><span className="text-yellow-600">Composition:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
          <p><span className="text-yellow-600">Atmospheric pressure:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
          <p><span className="text-yellow-600">Climate:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
          <p><span className="text-yellow-600">Winds:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit assumenda nostrum delectus itaque quia maxime at accusamus illum autem ad. Atque, ducimus. Veritatis ipsam itaque qui, porro quis alias eos!</p>
        </div>
      </div>
      ...
      <div className="w-[800px] flex gap-5 flex-col max-[900px]:w-[600px] max-[700px]:w-[300px]">
        <h3 className="text-yellow-600 text-3xl text-center mb-3">Natural Satellites</h3>
        <div className="flex gap-5 max-[700px]:flex-col">
          <div className="flex flex-col justify-between items-start">
            <p><span className="text-yellow-600">Moon:</span> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis mollitia natus eum eos ducimus atque officiis expedita quaerat error, perspiciatis illo nesciunt laboriosam explicabo dolorem optio velit harum laudantium nemo?</p>
            <Button variant={"link"} className="hover:text-yellow-600">
        ...
        <div className="flex gap-5 max-[700px]:flex-col">
          ...
          <div className="flex flex-col justify-between items-end">
            <p><span className="text-yellow-600">Moon:</span> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Delectus facere ullam a reiciendis aspernatur voluptate numquam, rerum saepe totam soluta officiis eius laudantium corrupti sed, earum pariatur sit, quam nesciunt?</p>
            <Button variant={"link"} className="hover:text-yellow-600">
              <a href="" target="_blank">Learn More</a>
            </Button>
          </div>
