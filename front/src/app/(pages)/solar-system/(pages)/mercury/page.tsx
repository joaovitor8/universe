      ...
      <div className="w-[300px] text-justify space-y-10 sm:w-[500px] md:w-[700px] lg:w-[1000px]">
        <div>
          <div className="md:flex md:gap-3">
            <div>
              <h1 className="text-5xl text-purple-700 mb-3">Mercury: The Closest Planet to the Sun</h1>
            ...
            <img src="/planets/mercury.png" alt="Planet" className="my-4 md:w-1/2 md:flex" />
          </div>
